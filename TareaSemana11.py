...
class Mostrar():
    ...
    # Funcion  subir imagen desde los archivos 
    ...
    # Funcion  aplicar efecto blanco y negro 
    def Blanco(self):
        if self.archivo !="":
    ...
    # Funcion  aplicar efecto desenfocar
    def desenfocar(self):
        if self.archivo !="":
            Nuestra_Imagen1 = Image.open(self.archivo)
    ...
    def contorno(self):
        if self.archivo !="":
            ...
            messagebox.showerror("Imagen", "Necesita cargar una imagen")
    # Funcion  aplicar efecto resaltar
    def Resal(self):
        if self.archivo !="":
            Nuestra_Imagen1 = Image.open(self.archivo)
